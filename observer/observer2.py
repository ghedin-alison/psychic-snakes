...
class AgenciaNoticias:
    ...
    def cancel_inscricao(self, inscrito=None):
        if not inscrito:
...
if __name__ == '__main__':
    ...
    agencia_noticias.adicionar_noticia('Novo curso publicado!!')
    agencia_noticias.notificar_todos()

    print(f'Descadastrado: {type(agencia_noticias.cancel_inscricao()).__name__}')
    print(f'Inscritos:: {agencia_noticias.inscritos()}')

    agencia_noticias.adicionar_noticia('Vagas desenvolvedor python!!')
    agencia_noticias.notificar_todos()
